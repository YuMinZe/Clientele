...
//		imgGridView.setOnItemClickListener(this);
			...
			if (checkBox.isChecked()) {
				...
				try {
					...
					if (imageView !=null) {
						...
						choise_button.setText("已选择("+select_layout.getChildCount()+")多少张");
					}
	...
	public void sendfiles(View view){
		if(select_layout.getChildCount()<=4){
			Intent intent =new Intent(this, Anjianweituo_tuo.class);
			...
			Toast.makeText(ImgsActivity.this,"最多选择4张照片",Toast.LENGTH_SHORT).show();
		}
