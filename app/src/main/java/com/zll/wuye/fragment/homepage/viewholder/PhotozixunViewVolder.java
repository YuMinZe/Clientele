 ...
 */
public class PhotozixunViewVolder extends RecyclerView.ViewHolder {
    ...
    public PhotozixunViewVolder(View itemView) {
        super(itemView);
        ...
        jiage = (TextView) itemView.findViewById(R.id.home_dianhuazixun_jiage);
